...
def main():
    ...
    p.add_argument("--doge-rpcip", default=None)
    p.add_argument("--doge-rpcport", type=int, default=None)
    p.add_argument("--doge-rpcuser", default=None)
    p.add_argument("--doge-rpcpass", default=None)
    p.add_argument("--doge-address", default=None)
    ...
    p.add_argument("--ltc-zmq-endpoint", default=None, help="LTC ZMQ endpoint")
    p.add_argument("--mewc-zmq-endpoint", default=None, help="MEWC ZMQ endpoint")
    p.add_argument("--doge-zmq-endpoint", default=None, help="DOGE ZMQ endpoint")
    args = p.parse_args()
    ...
    if not s.rpcuser or not s.rpcpass:
        raise SystemExit(
            "LTC RPC credentials are required (--rpcuser/--rpcpass or env vars)."
        )
    run_with_settings(s)
