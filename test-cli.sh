...
docker compose exec litecoin litecoin-cli -datadir="/home/litecoin/.litecoin" getblockchaininfo | head -5
echo

echo "Testing Dogecoin CLI connection..."
docker compose exec dogecoin dogecoin-cli -datadir="/home/dogecoin/.dogecoin" getblockchaininfo | head -5
echo

echo "Testing Meowcoin CLI connection..."  
docker compose exec meowcoin meowcoin-cli -datadir="/home/meowcoin/.meowcoin" getblockchaininfo | head -5
echo
